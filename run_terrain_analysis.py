#!/usr/bin/env python3
"""
⚠️  DEPRECATED: run_terrain_analysis.py
=======================
...
To run the legacy script:
    python scripts/analysis/legacy_runners/run_terrain_analysis.py
"""
...
def main():
    print("⚠️  DEPRECATED: run_terrain_analysis.py")
    print("=" * 60)
    ...
    legacy_path = Path("scripts/analysis/legacy_runners/run_terrain_analysis.py")
