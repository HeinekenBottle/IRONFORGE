#!/usr/bin/env python3
"""
⚠️  DEPRECATED: run_global_lattice.py
=====================
...
To run the legacy script:
    python scripts/analysis/legacy_runners/run_global_lattice.py
"""
...
def main():
    print("⚠️  DEPRECATED: run_global_lattice.py")
    print("=" * 60)
    ...
    legacy_path = Path("scripts/analysis/legacy_runners/run_global_lattice.py")
