#!/usr/bin/env python3
"""
⚠️  DEPRECATED: run_specialized_lattice.py
==========================
...
To run the legacy script:
    python scripts/analysis/legacy_runners/run_specialized_lattice.py
"""
...
def main():
    print("⚠️  DEPRECATED: run_specialized_lattice.py")
    print("=" * 60)
    ...
    legacy_path = Path("scripts/analysis/legacy_runners/run_specialized_lattice.py")
