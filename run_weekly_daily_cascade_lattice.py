#!/usr/bin/env python3
"""
⚠️  DEPRECATED: Weekly→Daily Cascade Lattice Analysis
====================================================
...
To run the legacy script:
    python scripts/analysis/legacy_runners/run_weekly_daily_cascade_lattice.py
"""
...
def main():
    print("⚠️  DEPRECATED: run_weekly_daily_cascade_lattice.py")
    print("=" * 60)
    ...
    legacy_path = Path("scripts/analysis/legacy_runners/run_weekly_daily_cascade_lattice.py")
