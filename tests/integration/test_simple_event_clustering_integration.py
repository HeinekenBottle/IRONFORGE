...
def test_individual_components():
    ...
    try:
        ...
        htf_data = {"15m_phase": "expansion", "1h_structure": "uptrend", "daily_context": "ny_open"}
        ...
        print(
            f"✅ SimpleEventAnalyzer: {analysis_result['analysis_metadata']['total_events_analyzed']} events analyzed"
        )
...
def test_orchestrator_integration():
    ...
    try:
        ...
        test_graph = {
            ...
            "metadata": {"session_type": "asia_session"},
        }
...
def test_output_data_quality():
    ...
    try:
        ...
        print(
            f"✅ Event analysis count valid: {actual_events} events found (includes nodes + semantic_events)"
        )
