#!/usr/bin/env python3
"""
⚠️  DEPRECATED: extract_lattice_summary.py
==========================
...
To run the legacy script:
    python scripts/analysis/legacy_runners/extract_lattice_summary.py
"""
...
def main():
    print("⚠️  DEPRECATED: extract_lattice_summary.py")
    print("=" * 60)
    ...
    legacy_path = Path("scripts/analysis/legacy_runners/extract_lattice_summary.py")
