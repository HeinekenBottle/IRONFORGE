#!/usr/bin/env python3
"""
⚠️  DEPRECATED: run_weekly_daily_sweep_cascade_step_3b_refined.py
=================================================
...
To run the legacy script:
    python scripts/analysis/legacy_runners/run_weekly_daily_sweep_cascade_step_3b_refined.py
"""
...
def main():
    print("⚠️  DEPRECATED: run_weekly_daily_sweep_cascade_step_3b_refined.py")
    print("=" * 60)
    ...
    legacy_path = Path("scripts/analysis/legacy_runners/run_weekly_daily_sweep_cascade_step_3b_refined.py")
