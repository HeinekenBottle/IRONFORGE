#!/usr/bin/env python3
"""
⚠️  DEPRECATED: run_fpfvg_network_analysis_simple.py
====================================
...
To run the legacy script:
    python scripts/analysis/legacy_runners/run_fpfvg_network_analysis_simple.py
"""
...
def main():
    print("⚠️  DEPRECATED: run_fpfvg_network_analysis_simple.py")
    print("=" * 60)
    ...
    legacy_path = Path("scripts/analysis/legacy_runners/run_fpfvg_network_analysis_simple.py")
